...
const float LG_DISTORTION = 0.10;   // convex lens distortion strength
const float LG_ABERRATION = 1.5;    // chromatic aberration amount (in pixels)
const float LG_HIGHLIGHT  = 0.50;   // specular highlight brightness
const float LG_TINT       = 0.85;   // glass tint (absorption; 1.0 = clear)
